...
const Contact = () => {
  return (
    <div id="contact" className="flex justify-center items-center p-16 bg-slate-100">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="bg-white border border-gray-300 p-4 rounded-lg flex flex-col items-center">
          <img src="discord-icon.png" alt="Discord" className="w-12 h-12 mb-4" />
        ...
        <div className="bg-white border border-gray-300 p-4 rounded-lg flex flex-col items-center">
          <img src="email-icon.png" alt="Correo" className="w-12 h-12 mb-4" />
        ...
        <div className="bg-white border border-gray-300 p-4 rounded-lg flex flex-col items-center">
          <img src="whatsapp-icon.png" alt="WhatsApp" className="w-12 h-12 mb-4" />
